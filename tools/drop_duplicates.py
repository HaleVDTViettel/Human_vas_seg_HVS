...
coco = COCO('/media/thanhha/Utilities/Thanhha/ComputerVision/DAT302m/human_vas/data/dtrain_dataset2.json')
count = 0
valid_ann_ids = []
...
d = mmengine.load('/media/thanhha/Utilities/Thanhha/ComputerVision/DAT302m/human_vas/data/dtrain_dataset2.json')
annotations = [
    ann for ann in d['annotations']
    if ann['id'] in valid_ann_ids
]
d['annotations'] = annotations
mmengine.dump(d, '/media/thanhha/Utilities/Thanhha/ComputerVision/DAT302m/human_vas/data/dtrain_dataset2_dropdup.json')