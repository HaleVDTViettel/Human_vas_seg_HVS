...
class MultiEMADetector(BaseDetector):
    '''Keep multiple EMA models during training. For semi-supervised learning.
    Modified from mmdet.models.detectors.semi_base.SemiBaseDetector to keep multiple EMA models.
    '''
    def __init__(self,
